...
subtitle: "Water damage, worn boards, floors hidden under carpet — we bring them back"
intro: "Some of the most beautiful floors in Helena have been hiding under carpet for 40 years. Others have taken on water near the front door, or dried out and gapped beside a wood stove. We bring them back to life — and we're honest with you about what's actually there before we start."
gallery:
  - image: "/images/repair_1.jpg"
    alt: "Hardwood floor board replacement and weaving repair in progress"
    caption: "Board replacement — weaving new stock into existing floor"
  - image: "/images/repair_2.jpg"
    alt: "Historic fir floor restoration in progress, Helena, MT"
    caption: "Historic fir floor mid-restoration"
  - image: "/images/repair_3.jpg"
    alt: "Completed hardwood floor repair with matched grain and finish"
    caption: "Completed repair — new boards blended into existing floor"
  - image: "/images/restoration_1.jpg"
    alt: "Turn-of-the-century fir floor restored to original character, Helena"
    caption: "Turn-of-the-century fir restored to original character"
  - image: "/images/before_after_repair.jpg"
    alt: "Before and after hardwood floor restoration showing water damage repair"
...
1. **On-site estimate.** We assess the extent of the damage, check the subfloor condition, and identify any structural issues that need to be addressed before sanding or finishing can happen. You'll know what you're working with before any work begins.
2. **Board replacement.** Boards that are blackened, buckled, or structurally compromised come out first. We source replacement stock that matches as closely as possible — species, width, and character — and weave each piece in by hand.
3. **Subfloor repair.** If the subfloor has taken on moisture or shifted, it gets addressed here. Sanding over a bad subfloor produces a bad result.
4. **Sanding.** We sand through multiple grits to reach bare, clean wood across the entire surface — not just the areas that were repaired. This is what makes the floor read as one consistent piece.
5. **Staining and finishing.** We apply stain if you're changing the color, then multiple coats of finish with sanding between coats. We specialize in water-based finishes, which cure faster, handle Montana's seasonal wood movement well, and let the natural color of the wood come through.
