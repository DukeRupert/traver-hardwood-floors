...
seo_title: "Hardwood Floor Refinishing | Helena & Bozeman, MT | Traver Hardwood Floors"
...
# /refinishing/ was consolidated into this page — it targeted the same query with
# near-duplicate content. Keep this alias so the old URL redirects here.
aliases:
  - /refinishing/
...
intro: "Chris specializes in water-based finishes. Not because they're newer, but because they perform better in Montana's climate. Dry winters, wood stoves, forced-air heat — all of it puts stress on a finish. Water-based products cure faster, flex better with seasonal wood movement, and hold up without the heavy odor that makes oil-based finishing a multi-day disruption to your home."
process_eyebrow: "The refinishing process"
process_headline: "What to expect, start to finish."
process_steps:
  - title: "Floor assessment"
    description: "Chris inspects the floor — checking for moisture issues, structural problems, and how many times it's been sanded before. A floor that's been sanded too many times can't be safely sanded again. We'll tell you that honestly if it's the case."
  - title: "Sanding"
    description: "Drum or belt sanding down to bare wood, followed by progressively finer grits. Edges and corners done by hand. The final passes determine how the grain reads — this step isn't rushed."
  - title: "Stain (if applicable)"
    description: "If you're changing the floor's color, stain is applied after sanding and before finish. A wide range of custom stain options are available — from natural and clear to darker walnut tones. We can show you samples on your actual wood."
  - title: "Finishing coats & cure"
    description: "Two to three coats of water-based finish, with light screening between coats. Cure time varies — typically 24 hours before light foot traffic, 72 hours before rugs and furniture. We'll walk you through the schedule before we start."
gallery:
  - image: "/images/sanding_1.jpg"
    alt: "Antique hardwood floor with red stain sanded to bare wood, Helena, MT"
    caption: "Antique hardwood — red stain removed to bare wood"
  - image: "/images/sanding_2.jpg"
    alt: "Hardwood floor after full old finish removal, ready for refinishing"
    caption: "Old finish fully removed, ready for new coats"
  - image: "/images/sanding_3.jpg"
    alt: "Refinished hardwood floor showing restored grain detail"
    caption: "Grain detail restored after full sand and refinish"
  - image: "/images/sanding_4.jpg"
    alt: "Hardwood floor before and after refinishing comparison"
    caption: "Before and after — same floor, new finish"
features_title: "Why Refinish Your Floors"
features:
  - title: "Most Floors Can Be Saved"
    description: "Even floors that look past their prime — scratched, discolored, or covered under old carpet for decades — usually sand down to sound wood. We've restored floors other contractors walked away from."
  - title: "A Fraction of Replacement Cost"
    description: "Refinishing costs significantly less than tearing out and replacing hardwood. If your floors have the thickness to sand, refinishing is almost always the smarter choice."
  - title: "Custom Color Without Starting Over"
    description: "Want to go lighter? Darker? A fresh sand gives you a clean slate for stain. You can change the whole feel of a room without touching the floor structure beneath your feet."
---
...
1. **On-site estimate.** We look at your floors, assess the finish condition, check for soft spots or structural issues, and talk through what you want the end result to look and feel like. This is where we tell you honestly whether a full sand-and-refinish is warranted, or whether a buff-and-recoat will do the job.

2. **Prep and dust containment.** We cover doorways and HVAC vents to keep fine sanding dust out of the rest of your home. Clear the room of furniture and anything hanging on nearby walls before we arrive — sanding vibration travels.

3. **Sanding.** We work through progressively finer grits, starting coarse enough to cut through old finish and minor surface damage, finishing fine enough that the wood is smooth and ready to take a stain or clear coat evenly. Edges and corners are done by hand.

4. **Stain (if applicable).** If you're changing the color of your floors, stain goes on after sanding and before the finish coats. This is also when color-matching for repairs or additions happens.

5. **Finish coats.** We apply multiple coats, sanding lightly between each, until the surface has the depth and durability it needs. Water-based finishes are dry to the touch within a few hours; we typically plan for light foot traffic the following day and full use within a few days.

6. **Cure and care.** The finish continues to harden for several weeks after the final coat. We'll give you specific instructions for your floor — including what to put on it, what to keep off it, and how long to wait before rugs go back down.
